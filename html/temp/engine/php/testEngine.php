...
if ($testBook) {
    ...
    $frag = new Html_fragment("../html/server-run.html", [
        ["PATH_TO_ENGINE", "../"],
        ["ENGINE", "$engineCode"],
        ["START_PAGE", 0],
        ...
        ["BUILD_POST_SPECS", "{dummy: 'specs'}"],
        ["BUILD_POST_LOC", "dummy.php"],
        ["PUBBLY_JSON", file_get_contents("../testBooks/$testBook/Main.json")],
    ]);
    $frag->echoOut();
}   else    {
