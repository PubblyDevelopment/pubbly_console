function PubblyDom(xml, environment) {
    ...
    this.build = function (environment) {
        ...
        // UI cont
        $("#pubbly_main #cancover").append("<div id='uiCont'></div>");
        ...
        $("#pubbly_main").append('<div id="audCont" style="display:none"></div>');
        ...
        if (info.display == "composite") {
            ...
            $("#pubbly_main #canvases #cancover").append(`<div class='previousSpreadLeft canPlacer'>
                <canvas height=${info.height} width=${info.width} style="height:${info.height}px;"
            ...
            $("#pubbly_main #canvases #cancover").append(`<div class='previous canPlacer'>
                <canvas height=${info.height} width=${spreadWidth} style="height:${info.height}px;"
