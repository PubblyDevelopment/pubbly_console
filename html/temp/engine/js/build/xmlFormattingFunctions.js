    ...
    if (partial !== false) {
        ...
        for (let a = 0; a < anims.length; a++) {
            ...
            if (!dataString || !dataString.split) {
                // play in place looks like this, but isn't error... Can't throw.
                console.warn(`Error parsing animation: ${partial}`);
                // throw {
                //     message: `Error parsing animation: ${partial}`,
                //     fatal: true,
                // };
            } else {
                ...
                if (legs.length > 1) {
                    ...
                    throw {
                        message: "Cannot parse animation, only one leg",
                        fatal: false,
                    };
                }
            }
