...
class AssetListLoader {
    ...
    download(asset, cbs) {
        ...
        if (asset.type === "image" || (asset.type === "gif" && asset.ext === "gif")) {
        ...
        } else if (asset.type === "video" || asset.type === "gif") {
        ...
        if (typeof asset.elem.load === "function") {
            asset.elem.load(); // Safari doesn't load audios by simply setting the source
        }
    }
