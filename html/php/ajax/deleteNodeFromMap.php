...
if (LOGGED_IN) {
    ...
    $info = $query->fetchSingle("SELECT mp.name AS map_name, mn.name AS node_name FROM map mp RIGHT JOIN map_node mn ON mn.map_id = mp.map_id WHERE mn.map_node_id = ?", ["s", $mapID]);
